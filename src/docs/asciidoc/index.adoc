...
.Sample Request
include::{snippets}/common/techs/http-request.adoc[]

.Sample Response
include::{snippets}/common/techs/http-response.adoc[]

.Request parameters

조회를 위한 request parameter의 설명입니다.
include::{snippets}/common/techs/request-parameters.adoc[]

.Response Body
include::{snippets}/common/techs/response-body.adoc[]
include::{snippets}/common/techs/response-fields.adoc[]
...
.Sample Request
include::{snippets}/common/ranks/http-request.adoc[]

.Sample Response
include::{snippets}/common/ranks/http-response.adoc[]

.Request parameters

조회를 위한 request parameter의 설명입니다.
include::{snippets}/common/ranks/request-parameters.adoc[]

.Response Body
include::{snippets}/common/ranks/response-body.adoc[]
include::{snippets}/common/ranks/response-fields.adoc[]
...
.Request Params
include::{snippets}/problems/long/grade/request-parameters.adoc[]
...
.Sample Request
include::{snippets}/problems/grade/assessment/http-request.adoc[]

.Sample Response
include::{snippets}/problems/grade/assessment/http-response.adoc[]

.Path parameters
include::{snippets}/problems/grade/assessment/path-parameters.adoc[]

객관식 문제 단건 조회를 위한 path parameter의 설명입니다.

.Request Header
request를 살펴보면 Authorization 헤더에서 Bearer token 형태로, access token을 전달하는 것을 알 수 있습니다.
include::{snippets}/problems/grade/assessment/request-headers.adoc[]

.Request Body
include::{snippets}/problems/grade/assessment/request-body.adoc[]
include::{snippets}/problems/grade/assessment/request-fields.adoc[]
...
.Sample Request
include::{snippets}/problems/v2/challenge/http-request.adoc[]

.Path parameters
include::{snippets}/problems/v2/challenge/path-parameters.adoc[]

이의 제기를 위한 path parameter의 설명입니다.

.Request Header
request를 살펴보면 Authorization 헤더에서 Bearer token 형태로, access token을 전달하는 것을 알 수 있습니다.
include::{snippets}/problems/v2/challenge/request-headers.adoc[]

.Request Body
include::{snippets}/problems/v2/challenge/request-body.adoc[]
include::{snippets}/problems/v2/challenge/request-fields.adoc[]

.Sample Response
include::{snippets}/problems/v2/challenge/http-response.adoc[]
...
.Sample Request
include::{snippets}/problem-sets-findall/http-request.adoc[]

.Sample Response
include::{snippets}/problem-sets-findall/http-response.adoc[]

.Response Body
include::{snippets}/problem-sets-findall/response-body.adoc[]
include::{snippets}/problem-sets-findall/response-fields.adoc[]
...
.Sample Request
include::{snippets}/problem-sets-find/http-request.adoc[]

.Sample Response
include::{snippets}/problem-sets-find/http-response.adoc[]
...
==== 글 조회 API ( /api/v1/problem/{problemId}/posts )
.description
[source]
----
글을 조회하기 위한 API입니다.
...
HTTP Method : GET
End-Point   : /api/v1/problem/{problemId}/posts
----
...
==== 댓글 작성 API ( /api/v1/posts/{postId}/comments )
.description
[source]
----
댓글을 생성하기 위한 API입니다.
...
[source]
----
유저 답안 라벨링 유저 할당을 위한 API입니다.

HTTP Method : PUT
End-Point   : /api/admin/user-answers/assign/validate
----

.Sample Request
include::{snippets}/admin/userAnswer/assign/label/http-request.adoc[]

.Sample Response
include::{snippets}/admin/userAnswer/assign/label/http-response.adoc[]

.Request Body
include::{snippets}/admin/userAnswer/assign/label/request-body.adoc[]
include::{snippets}/admin/userAnswer/assign/label/request-fields.adoc[]

.Response Body
include::{snippets}/admin/userAnswer/assign/label/response-body.adoc[]
include::{snippets}/admin/userAnswer/assign/label/response-fields.adoc[]
...
.Sample Request
include::{snippets}/admin/userAnswer/assign/validate/http-request.adoc[]

.Sample Response
include::{snippets}/admin/userAnswer/assign/validate/http-response.adoc[]

.Request Body
include::{snippets}/admin/userAnswer/assign/validate/request-body.adoc[]
include::{snippets}/admin/userAnswer/assign/validate/request-fields.adoc[]
...
.Sample Request
include::{snippets}/admin/notifications/delete/http-request.adoc[]

.Request Body
include::{snippets}/admin/notifications/delete/request-body.adoc[]
include::{snippets}/admin/notifications/delete/request-fields.adoc[]

.Sample Response
include::{snippets}/admin/notifications/delete/http-response.adoc[]

.Response Body
include::{snippets}/admin/notifications/delete/response-body.adoc[]
include::{snippets}/admin/notifications/delete/response-fields.adoc[]
...
.Sample Request
include::{snippets}/problem-sets-create/http-request.adoc[]

.Sample Response
include::{snippets}/problem-sets-create/http-response.adoc[]

.Request Body
include::{snippets}/problem-sets-create/request-body.adoc[]
include::{snippets}/problem-sets-create/request-fields.adoc[]

.Response Body
include::{snippets}/problem-sets-create/response-body.adoc[]
include::{snippets}/problem-sets-create/response-fields.adoc[]
...
.Sample Request
include::{snippets}/problem-sets-update/http-request.adoc[]

.Path parameters
include::{snippets}/problem-sets-update/path-parameters.adoc[]

문제 세트 단건 조회을 위한 path parameter의 설명입니다.

.Request Body
include::{snippets}/problem-sets-update/request-body.adoc[]
include::{snippets}/problem-sets-update/request-fields.adoc[]

.Sample Response
include::{snippets}/problem-sets-update/http-response.adoc[]

.Response Body
include::{snippets}/problem-sets-update/response-body.adoc[]
include::{snippets}/problem-sets-update/response-fields.adoc[]
