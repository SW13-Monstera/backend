...
import io.csbroker.apiserver.service.Problem.AdminProblemService
...
class AdminController2(
    ...
    @Qualifier("adminLongProblemService") private val longProblemService: AdminProblemService,
    @Qualifier("adminShortProblemService") private val shortProblemService: AdminProblemService,
    @Qualifier("adminMultipleProblemService") private val multipleProblemService: AdminProblemService,
